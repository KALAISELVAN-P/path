...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: 'support@potholedetect.com',
      description: 'We reply within 24 hours'
    },
    {
      icon: MapPin,
      title: 'Address',
      details: '123 Smart City Ave, Tech District',
  ...
  const departments = [
    {
      ...
      email: 'tech@potholedetect.com',
      description: 'System issues and technical queries'
    },
    {
      icon: Clock,
      title: 'Emergency Response',
      phone: '+1 (555) 911-ROAD',
      description: 'Critical road safety issues'
    }
  ];
            ...
            <div className="card bg-blue-50 border-blue-200">
              ...
              <div className="space-y-2 text-blue-800">
                ...
                <div className="mt-4 pt-4 border-t border-blue-200">
                  <p className="text-sm">
                    <strong>Emergency Response:</strong> Available 24/7 for critical road safety issues
                  </p>
                </div>
              </div>
            </div>
