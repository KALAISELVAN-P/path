      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-blue-50/80 to-blue-100/60 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-blue-200/30"
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-lg">Ultrasonic Sensor</h3>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-purple-50/80 to-purple-100/60 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-purple-200/30"
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-lg">Gyroscope</h3>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-green-50/80 to-green-100/60 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-green-200/30"
            >
              <div className="flex items-center justify-between mb-4">
              ...
              <div className="space-y-2">
                <div>
                  <p className="text-sm text-gray-600">Latitude</p>
                  <p className="font-semibold">{esp32Data.gps.latitude.toFixed(6)}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Longitude</p>
                  <p className="font-semibold">{esp32Data.gps.longitude.toFixed(6)}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Accuracy</p>
                  <p className="font-semibold">{esp32Data.gps.accuracy}m</p>
                </div>
              </div>
            </motion.div>
        </div>
